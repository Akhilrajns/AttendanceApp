...
def TrackImages():
    ...
    while True:
        ...
        if (conf < 30):
            ...
            top.title("User Identified")
            Label(top, text="Welcome {} ID {}".format("".join(aa), Id), font=('times', 12, ' bold ')).place(x=50, y=80)
            break
...
takeImg = tk.Button(window, text="Add User",
...
trainImg = tk.Button(window, text="Training",
                     ...
                     width=10, height=2, activebackground="Red",
                     font=('times', 12, ' bold '))
trainImg.place(x=220, y=400)
trackImg = tk.Button(window, text="Scan",
                     command=TrackImages, fg="white", bg="green",
                     width=10, height=2, activebackground="Red",
                     font=('times', 12, ' bold '))
trackImg.place(x=380, y=400)
quitWindow = tk.Button(window, text="Quit",
                       command=window.destroy, fg="white", bg="green",
                       width=10, height=2, activebackground="Red",
                       font=('times', 12, ' bold '))
quitWindow.place(x=550, y=400)
